...
function ToysHobbiesRobots() {
    ...
    const latestProduct = async () => {
        try {
            ...
            setLoading(true);
            setErrors({});
            const {data} = await api.getTwoSlug('toys-latest-product', 'latest_product');
    ...
    const bestSellingProduts = async () => {
        try {
            ...
            setLoading(true);
            setErrors({});
            const {data} = await api.getTwoSlug('toys-latest-product', 'best_selling');
    ...
    const topRatingProduts = async () => {
        try {
            ...
            setLoading(true);
            setErrors({});
            const {data} = await api.getTwoSlug('toys-latest-product', 'top_rating');
    ...
    const featureProduts = async () => {
        try {
            ...
            setLoading(true);
            setErrors({});
            const {data} = await api.getTwoSlug('toys-latest-product', 'featured');
