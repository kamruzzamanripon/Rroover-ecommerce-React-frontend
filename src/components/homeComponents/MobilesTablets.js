...
import useMobilesTabletsContextHook from "../../context/homepage/sectionFetchContext/MobilesTabletsContextHook";

function MobilesTablets() {

    const {bestSellingProduts, featureProduts, latestProduct, menProduts, topRatingProduts, errors, loading} = useMobilesTabletsContextHook()
