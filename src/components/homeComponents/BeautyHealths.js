...
import useBeautyHealthsContextHook from "../../context/homepage/sectionFetchContext/BeautyHealthsContextHook";

function BeautyHealths() {

    const {topRatingProduts, menProduts, latestProduct, featureProduts, bestSellingProduts, errors, loading} = useBeautyHealthsContextHook()
            ...
            <section className="section-maker">
                <div className="container">
                    <div className="sec-maker-header text-center">
                        <h3 className="sec-maker-h3">Beauty &amp; Helath</h3>
